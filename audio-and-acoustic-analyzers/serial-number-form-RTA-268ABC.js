function changeText() {
  ...
  http.open("HEAD", "https://www.virtins.com/CalibrationFiles/VT-RTA-268ABC/" + SerialNoInput + ".zip", false);
  http.send();
  if (http.status != 404) {
    DownloadLink.href = "https://www.virtins.com/CalibrationFiles/VT-RTA-268ABC/" + SerialNoInput + ".zip";
